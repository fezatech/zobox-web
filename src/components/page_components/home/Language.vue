    ...
    <section class="section language pb-0">
        ...
        <div class="language__slider">
            <div class="swiper-wrapper">
                ...
                <div class="language__slider-single swiper-slide">
                    <div class="thumb">
                        <img :src="require('@/assets/images/flag/usa.png')" alt="Image">
                    </div>
                ...
                <div class="language__slider-single swiper-slide">
                    <div class="thumb">
                        <img :src="require('@/assets/images/flag/portugal.png')" alt="Image">
                    </div>
                    <p class="fw-5">Portuguese</p>
                </div>
                <div class="language__slider-single swiper-slide">
                    <div class="thumb">
                        <img :src="require('@/assets/images/flag/australia.png')" alt="Image">
                    </div>
...
<script scoped>
    ...
    export default {
        ...
        mounted() {
            ...
            new Swiper('.language__slider-rtl', {
                slidesPerView: 'auto',
                slidesPerGroup: 12,
                loop: true,
                speed: 80000,
