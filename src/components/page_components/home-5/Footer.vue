...
<style scoped>
    .footer-two {
        background-image: url('~@/assets/images/home-five/home-five-footer.png');
    }

    .home-five-light .footer-two {
        background-image: url('~@/assets/images/home-five/light-footer.png');
    }

    .footer-two__form {
        background-image: url('~@/assets/images/home-five/form-bg.png');
    }
</style>