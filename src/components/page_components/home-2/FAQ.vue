<template>
    <section class="section faq-two pb-0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section__header--secondary wow fadeInUp" data-wow-duration="600ms"
                        ...
                        <div class="row align-items-center items-gap">
                            ...
                            <div class="col-12 col-xl-5">
                                <div class="faq-two__switch">
                                    <p class="abc cd">General Questions</p>
                                    <div class="switcher">
                                        <input type="checkbox" id="switch">
                                        <label for="switch">Toggle</label>
                                    </div>
                                    <p class="atc">Members & Contributors</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="faq-tab-content" id="faqOne">
                    ...
                    <div class="faq-tab-content" id="faqTwo">
                            ...
                            <div class="row items-gap">
                                <div class="col-12 col-lg-6">
                                    <div class="faq__two-right">
                                        <div class="accordion-item content__space wow fadeInUp"
                                            data-wow-duration="600ms" data-wow-delay="1500ms">
                                            <h5 class="accordion-header" id="memberheadingFour">
                                                <button class="accordion-button collapsed" type="button"
                                        ...
                                        <div class="accordion-item content__space wow fadeInUp"
                                            data-wow-duration="600ms" data-wow-delay="1500ms">
                                            <h5 class="accordion-header" id="memberheadingFive">
                                                <button class="accordion-button collapsed" type="button"
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="faq__two-left">
                                        <div class="accordion-item wow fadeInUp" data-wow-duration="600ms"
                                            data-wow-delay="600ms">
                                            <h5 class="accordion-header" id="memberheadingOne">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
...
export default {
    ...
    mounted() {
        ...
        const atcLabel = document.querySelector('.atc');
        const abcLabel = document.querySelector('.abc');

        // Show the first tab content
        faqTabContents[0].style.display = 'block';

        // Add change event listener to the switch
        switchElement.addEventListener('change', function () {
            // Hide all tab contents
            faqTabContents.forEach((content) => content.style.display = 'none');
            atcLabel.classList.remove('cd');
            abcLabel.classList.remove('cd');

            // Show the selected tab content with fade-in animation
            if (this.checked) {
                document.getElementById('faqTwo').style.display = 'block';
                atcLabel.classList.add('cd');
            } else {
                document.getElementById('faqOne').style.display = 'block';
                abcLabel.classList.add('cd');
            }
        });
    }
}
